...
document.addEventListener("DOMContentLoaded", function () {
  ...
  async function fetchCandidates() {
      ...
      top4Candidates.forEach((candidate, index) => {
        ...
        card.innerHTML = `
          ...
          rankColors[index]
                            ...
                            <img src="../assets/img/candidate_pic/${candidate.candidate_pic}.png"} alt="Candidate" class="w-16 h-16 rounded-full border-3 border-yellow-300 mb-2">
    ...
    if (container) {
      ...
      candidates.forEach((candidate, index) => {
        ...
        card.innerHTML = `
                            <img src="../assets/img/candidate_pic/${candidate.candidate_pic}.png" alt="Candidate" class="w-20 h-20 rounded-full">
    ...
    candidates.forEach((candidate) => {
      ...
      progress.innerHTML = `
                        <div class="flex items-center mb-3">
                            <img src="../assets/img/candidate_pic/${candidate.candidate_pic}.png" alt="Candidate" class="w-12 h-12 rounded-full mr-4">
  ...
  async function fetchTable() {
    try {
      ...
      ["2", "4", "5"].forEach((sem) => {
        document.getElementById(`semester${sem}Rate`).textContent = "0.0%";
